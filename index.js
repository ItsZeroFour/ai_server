...
const output = await replicate.run(
  ...
  {
    input: {
      input_file: "http://194.58.126.122:3000/image/image.png",
      output_format: "webp",
      workflow_json: JSON.stringify({
        ...
        15: {
          inputs: {
            image: "http://194.58.126.122:3000/image/image.png",
            upload: "image",
          },
        ...
        19: {
          inputs: {
            image:
              "http://194.58.126.122:3000/image/ComfyUI_temp_iovga_00002_.png",
            upload: "image",
          },
          class_type: "LoadImage",
          _meta: {
        ...
        71: {
          inputs: {
            image: "http://194.58.126.122:3000/image/Goodvar1Mask.png",
            upload: "image",
          },
          class_type: "LoadImage",
          _meta: {
